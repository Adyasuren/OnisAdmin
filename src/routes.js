...
import OnisShop_UserList from './containers/OnisShop/OnisShop_UserList';
...
export default (
	<Router history={browserHistory}>
		<Route path="/" name="Home" component={requireAuth(Full)}>
			...
			<Route path="sellerCalculation" name="SellerCalculation" component={SellerCalculation} />

			<IndexRedirect to="licenseReport" />
			<Route path="licenseReport" name="LicenseReport" component={LicenseReport} />

			<IndexRedirect to="banner" />
			<Route path="banner" name="Banner" component={Banner} />

			<IndexRedirect to="customeraddlist" />
			<Route path="customeraddlist" name="CustomerAddList" component={CustomerAddList} />
			...
			<Route path="customerDashboard" name="customerDashboard" component={customerDashboard} />

			<IndexRedirect to="paymentDashboard" />
			<Route path="paymentDashboard" name="paymentDashboard" component={paymentDashboard} />

			<IndexRedirect to="dashboard" />
			<Route path="dashboard" name="Dashboard" component={Dashboard} />

			<IndexRedirect to="licensestatus" />
			<Route path="licensestatus" name="licenseStatus" component={LicenseStatus} />

			<IndexRedirect to="desktopUser" />
			<Route path="desktopUser" name="desktopUser" component={desktopUser} />

			<IndexRedirect to="desktopBranch" />
			<Route path="desktopBranch" name="desktopBranch" component={desktopBranch} />

			<IndexRedirect to="desktopPayment" />
			<Route path="desktopPayment" name="desktopPayment" component={desktopPayment} />

			<IndexRedirect to="desktopcustomeradd" />
			<Route path="desktopcustomeradd" name="desktopcustomeradd" component={desktopcustomeradd} />

			<IndexRedirect to="desktopbranchadd" />
			<Route path="desktopbranchadd" name="desktopbranchadd" component={desktopbranchadd} />
			...
			<Route path="desktopcustomeredit" name="desktopcustomeredit" component={desktopcustomeredit} />

			<IndexRedirect to="desktopbranchedit" />
			<Route path="desktopbranchedit" name="desktopbranchedit" component={desktopbranchedit} />

			<IndexRedirect to="desktoppaymentedit" />
			<Route path="desktoppaymentedit" name="desktoppaymentedit" component={desktoppaymentedit} />

			<IndexRedirect to="blank" />
			<Route path="blank" name="Blank" component={Blank} />


			<IndexRedirect to="OnisShop_UserList" />
			<Route path="OnisShop_UserList" name="OnisShop_UserList" component={OnisShop_UserList} />
